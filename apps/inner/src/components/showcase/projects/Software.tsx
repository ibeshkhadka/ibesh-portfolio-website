    ...
    return (
        <div className="site-page-content">
            ...
            <div className="text-block">
                ...
                <br />
                <p>
                    This portfolio website — the site you are on right now —
                    is a 3D room rendered with Three.js, with a fully
                    interactive 2D desktop OS living on the computer monitor.
                    The 2D site is loaded inside the 3D scene through an
                    iframe and positioned with Three.js CSS rendering to give
                    the illusion of three dimensionality. Both parts live in a
                    single folder and are served by one server.
                </p>
                <br />
                ...
                <p>
                    ...
                    site inside of it using an iframe served same-origin at{' '}
                    <b>/os</b> by the unified server, and it works as a
                    standalone web app too. The actual rendering of
                ...
                <ul>
                    ...
                    {/* TODO(Ibesh): add your repository URLs below */}
                    <li>
                        <a rel="noreferrer" target="_blank" href="#">
                            <p>
                ...
                <p>
                    ...
                    interested sometime in the future.
                </p>
            </div>
            {/* TODO(Ibesh): the two project entries below are placeholders from
                the original template — replace them with your own projects. */}
            <div className="text-block">
                ...
                <ul>
                    ...
                    <li>
                        {/* TODO(Ibesh): add your assets repository URL */}
                        <a rel="noreferrer" target="_blank" href="#">
                            <p>
                                <b>[GitHub]</b> - Guntattchment Saga The Sequel
                                Assets Repository
            ...
            <div className="text-block">
                ...
                <br />
                <p>
                    While working as a frontend engineer, I spent a lot of time on GitHub
                ...
                <ul>
                    <li>
                        {/* TODO(Ibesh): add your repository URL */}
                        <a rel="noreferrer" target="_blank" href="#">
                            <p>
